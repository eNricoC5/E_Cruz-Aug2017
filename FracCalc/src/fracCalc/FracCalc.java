 ...
 public class FracCalc {
     ...
     public static String produceAnswer(String input) { 
        ...
        String[] secondOperand = new String[3];
         ...
         splitOperands(firstNum, firstOperand);
         splitOperands(secondNum, secondOperand);
         
         int wholeNum1 = Integer.parseInt(firstOperand[0]);
         int numeratorNum1 = Integer.parseInt(firstOperand[1]);
         int denominatorNum1 = Integer.parseInt(firstOperand[2]);
         
         int wholeNum2 = Integer.parseInt(secondOperand[0]);
         int numeratorNum2 = Integer.parseInt(secondOperand[1]);
         int denominatorNum2 = Integer.parseInt(secondOperand[2]);
      ...
      public static void splitOperands(String input2) {
     ...
     public static int toImproperFrac(int whole, int numerator, int denominator) {
    	 int imp;
    	 if (numerator > 0) {
 		imp= (whole * denominator) + numerator;
    	 } else {
    	imp= (whole * denominator) - numerator;
    	 }
 		return imp;
